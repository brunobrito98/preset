...
LicenseFile=
OutputDir=dist
OutputBaseFilename=preset-autosystem-setup-w11
Compression=lzma
...
[Files]
Source: "dist\preset-autosystem-w11.exe"; DestDir: "{app}"; DestName: "preset-autosystem.exe"; Flags: ignoreversion
